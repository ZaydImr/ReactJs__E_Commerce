...
const Navbar = () => {
  ...
  <nav className="flex justify-between bg-gray-100 border-b"> 
    <div className="px-12 py-2 flex w-full items-center">
      <Link className="lg:mr-8 2xl:mr-20 text-3xl font-bold font-heading" to="/">
        <img className="h-12" src={Logo} alt="" width="auto"/>
      </Link>
      <div className="hidden xl:flex max-w-xs items-center py-1 pl-4 pr-2 bg-white rounded-lg">
        <svg className="w-8" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M17.5 17.1309L12.5042 11.9551" stroke="black" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
          <path d="M7.27524 13.8672C10.8789 13.8672 13.8002 10.945 13.8002 7.34033C13.8002 3.73565 10.8789 0.813477 7.27524 0.813477C3.67159 0.813477 0.750244 3.73565 0.750244 7.34033C0.750244 10.945 3.67159 13.8672 7.27524 13.8672Z" stroke="black" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
        <input className="w-full border-0 focus:ring-transparent focus:outline-none p-2" type="text" placeholder=""/>
        <label className="pl-6 pr-6 border-0 border-l border-gray-100 focus:border-gray-100 focus:ring-transparent focus:outline-none">All&nbsp;items</label>
      </div>
      <ul className="hidden xl:flex px-4 mx-auto font-semibold font-heading"></ul>
    ...
    <Link className="hidden xl:flex items-center px-12 border-l font-semibold font-heading hover:text-gray-600" to='/login'>
    ...
    <Link className="xl:hidden flex mr-6 items-center text-gray-600" to="">
  ...
  <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
    ...
    <nav className="relative flex flex-col py-6 px-6 h-full w-full bg-white border-r overflow-y-auto">
      <div className="flex items-center mb-8">
        <Link className="mr-auto text-3xl font-bold font-heading" to="">
      ...
      <div className="flex mb-8 justify-between">
        <Link className="inline-flex items-center font-semibold font-heading" to='/login'>
          <svg className="mr-3" width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.0006 16.3154C19.1303 16.3154 21.6673 13.799 21.6673 10.6948C21.6673 7.59064 19.1303 5.07422 16.0006 5.07422C12.871 5.07422 10.334 7.59064 10.334 10.6948C10.334 13.799 12.871 16.3154 16.0006 16.3154Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M24.4225 23.8963C23.6678 22.3507 22.4756 21.0445 20.9845 20.1298C19.4934 19.2151 17.7647 18.7295 15.9998 18.7295C14.2349 18.7295 12.5063 19.2151 11.0152 20.1298C9.52406 21.0445 8.33179 22.3507 7.57715 23.8963" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
          </svg>
        ...
        <div className="flex items-center">
          ...
          <Link className="flex items-center" to="">
            ...
            <span className="inline-block w-6 h-6 text-center bg-gray-100 rounded-full font-semibold font-heading">3</span>
          </Link>
        </div>
      </div>
      <input className="block mb-10 py-5 px-8 bg-gray-100 rounded-md border-transparent focus:ring-blue-300 focus:border-blue-300 focus:outline-none" type="search" placeholder="Search"/>
      <ul className="text-3xl font-bold font-heading">
        <li className="mb-8"><Link to="">Category</Link></li>
        <li className="mb-8"><Link to="">Collection</Link></li>
        <li className="mb-8"><Link to="">Story</Link></li>
